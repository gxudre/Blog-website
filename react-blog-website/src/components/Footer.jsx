                ...
                <div className='grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4'>
                    <div>
                        ...
                        <ul className='mt-2 space-y-2'>
                            ...
                            <li>
                                <a href="/" className='text-gray-500 transition-colors duration-300 hover:text-orange-500'>Referencies</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    {/* Category 4 */}
                    <div>
                        <p className='font-medium tracking-wide text-gray-300'>Bussines</p>
                        <ul className='mt-2 space-y-2'>
                            <li>
                            ...
                            <li>
                                <a href="/" className='text-gray-500 transition-colors duration-300 hover:text-orange-500'>Work with us</a>
                            </li>
                        </ul>
                    </div>
                  ...
                  <div>
                        ...
                        <form className='mt-4 flex flex-col md:flex-row'>
                            <input type="email" name='email' id='email' placeholder='E-mail' className='flex-grow w-full h-12 px-4 mb-3 transition duration-200 bg-white border border-gray-300 rounded shadow-sm aspect-auto md:mr-2 md:mb-0 focus:border-purple-400 focus:outline-none' />
